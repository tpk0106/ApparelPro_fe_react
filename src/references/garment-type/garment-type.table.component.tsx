...
const GarmentTypesTable = ({
  ...
  //call UPDATE hook
  const { mutateAsync: updateGarmentType, isPending: isUpdatingGarmentType } =
...
export default GarmentTypesTable;
